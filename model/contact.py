...
class Contact:
    ...
    def __init__(self, firstname = None, middlename = None, lastname = None, phone2 = None, nickname = None,
                 title = None, company = None, address = None, home = None, mobile = None,
                 work = None, fax = None, email = None, email2 = None, email3 = None, homepage = None, bday = None,
